...
# https://suin.io/568から拝借しました。ありがとうございます。
...
: "プラグイン" && {
  ...
  #以下,zplug 以降に書いたものがプラグインされる
  zplug "zsh-users/zsh-autosuggestions" #入力中のコマンドをコマンド履歴から推測し、候補として表示するプラグイン。_https://github.com/zsh-users/zsh-autosuggestions
...
: "略語展開(iab)" && {
  abbrev-alias ls="ls -FG" # G: macOSで色を付ける
  abbrev-alias la="ls -aG"
